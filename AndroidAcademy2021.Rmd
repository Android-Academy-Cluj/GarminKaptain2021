...
//sampleStart
data class PointOfInterest(val name: String, val latitude: Double, val longitude: Double, val poiType: String)
...
class Temperature(val celsius: Float) {
    companion object {
        const val KELVIN_TO_CEELSIUS = -273.15f
        fun fromKelvin(kelvin: Float) = Temperature(kelvin + KELVIN_TO_CEELSIUS)
    }
}
...
## Enum Classes
```
enum class Language(isoCode: String) {
    ENGLISH("en"),
    FRENCH("fr"),
    GERMAN("de"),
    SPANISH("es"),
